  ...
  return (
    <section className="py-8 lg:py-0 lg:my-16 px-4 lg:px-0 mx-auto max-w-screen-md ">
      <div className="privacyheading">
        <h6 className="text-[50px] font-bold mb-4 text-white">Terms</h6>
      </div>
      <div className="privacycontent">
        <div className="leading-8 font-[400] text-[18px] flex flex-col gap-4">
          <p>
            Welcome to Revneo.com! This Privacy Policy explains how we collect,
            use, and disclose your personal information when you use our
            application and services. We take your privacy seriously and are
            committed to protecting your information. Please read this policy
          ...
          <ol className="privacypolicylist flex flex-col gap-4">
            ...
            <li className="flex flex-col gap-2">
              ...
              When you use Revneo.com, we may collect personal information that
              you provide voluntarily, such as your name, email address, and
              contact details. We may also collect information you provide when
              you contact our customer support or participate in surveys or
              promotions.
            </li>
            {/*  */}
            <li className="flex flex-col gap-2">
              ...
              <p>
                ...
                application, including the features you use and the settings you
                configure.
              </p>
            </li>
            {/*  */}
            <li className="flex flex-col gap-2">
              ...
              <p>
                Revneo.com may contain links to third-party websites, services,
                or advertisements. We are not responsible for the privacy
              ...
              <p>
                Revneo.com is not intended for children under the age of 13. We
                do not knowingly collect personal information from children. If
                we become aware of any personal information collected from a
              ...
              <p>
                ...
                you of any material updates by posting the revised policy on our
